...
class ApiClientTests(unittest.TestCase):
    ...
    @patch("src.api_client.requests.get") # path es el path del archivo que contiene la funcion que se va a mockear, esto para que no se haga la peticion real sino que se haga la peticion mockeada
