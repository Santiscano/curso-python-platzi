...
# se crean 3 interfaces que heredan de Protocol, y asi segregar las responsabilidades en interfaces
class PaymentProcessorProtocol(Protocol): # interface de procesamiento de pagos
    """
...
class RefundPaymentProtocol(Protocol): # interface de reembolso de pagos
    def refund_payment(self, transaction_id: str) -> PaymentResponse: ...


class RecurringPaymentProtocol(Protocol): # interface de pagos recurrentes
    def setup_recurring_payment(
        self, customer_data: CustomerData, payment_data: PaymentData
    ) -> PaymentResponse: ...


class StripePaymentProcessor( # implementacion de las 3 interfaces
...
class OfflinePaymentProcessor(PaymentProcessorProtocol): # solo implementa la interfaz de procesamiento de pagos
    def process_transaction(
        self, customer_data: CustomerData, payment_data: PaymentData
    ) -> PaymentResponse:
